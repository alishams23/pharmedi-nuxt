...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            axios
                .get(`http://127.0.0.1:8000/api/shop/list-products/?search=${this.text}${this.selected_categories.length > 0 ? '&categories=' + this.selected_categories.join('&category=') : ''}&ordering=${this.selected_sort}&min_price=${this.price_range[0]}&max_price=${this.price_range[1]}`, {
                    headers: {
