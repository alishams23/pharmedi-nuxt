        ...
        <div class="col-span-2">
          ...
          <div class="row">
            <div class="col-md-6 col-sm-12 col-6">
              ...
              <input required v-model="data.last_name" type="text"
                class="shadow-none rtl px-2 bg-white border-bottom" />
            </div>
            <div class="col-md-6 col-sm-12 col-6">
              <p class="text-right mt-3 fs-6">نام</p>
              <input required v-model="data.first_name" type="text"
                class="shadow-none rtl px-2 bg-white border-bottom" />
            </div>
            <div class="col-12">
              <p class="text-right mt-3 fs-6">نوع کاربری</p>
              <select class="form-select rtl shadow-none border-bottom py-2" aria-label="Default select example">
                <option value="N">کاربر عادی</option>
                <option value="S" selected>دانشجو</option>
                <option value="P">داروساز</option>
                <option value="T">تکنسین</option>
                <option value="H">مدیر داروخانه</option>
              </select>
            </div>
            <div class="rtl px-4 py-3">
              <button
                ...
                <div class="d-flex flex-column align-items-center" v-if="sendLoading == true">
