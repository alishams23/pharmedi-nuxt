    ...
    <div>
      <form @submit.prevent="sendData">
        <div class="grid rtl grid-cols-2 gap-3 lg:p-6 p-4">
          <div class="col-span-2" id="nameProduct">
            <label for="id_body" class="rtl fs-4 text-treaget irsa">ارتباط با ما</label>
            <p tag="div" class="text-right mt-3 fs-6 text-muted">
              نام و نام خانوادگی
            </p>
            <input v-model="name" type="text" required name="alt" maxlength="200"
              class="shadow-none rtl bg-gray-100 border-bottom" id="id_alt" />
          </div>

          <div class="col-span-2">
            <p class="text-right mt-3 fs-6 text-muted">توضیحات</p>
            <textarea name="body" v-model="body" cols="40" required rows="8"
              class="shadow-none bg-gray-100 border-bottom rtl p-3" id="id_body"></textarea>
          </div>
          <div class="col-span-2">
            <p class="text-right mt-3 fs-6 text-muted">ایمیل</p>
            <input type="email" name="alt" required v-model="email" maxlength="200"
              class="shadow-none rtl bg-gray-100 border-bottom" id="id_alt" />
          </div>
          <div>
      ...
      <div>
        <alert type="info">
          ...
          <p>اینستاگرام : instagram.com/treaget</p>
        </alert>
      </div>
        ...
        <div class="treaget-modal-card">
          <div class="treaget-modal-body">
            ...
            <div class="treaget-modal-footer">
              <div class="d-flex">
                <button class="bg-white py-2 border rounded-pill px-4" @click="modal = false">
                  بستن
                </button>
              </div>
            </div>
