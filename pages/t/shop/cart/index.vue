      ...
      <div v-else>
        <ol class="flex items-center w-full text-sm mt-5 font-medium text-center text-gray-500 sm:text-base">
          ...
          <li
            ...
            <span class="flex items-center after:content-['/'] sm:after:hidden after:mx-2 after:text-gray-200">
              ...
              <span v-else class="me-2 h-4 w-4 text-[9px] bg-gray-400 rounded-full text-white text-center">2</span>
          ...
          <li
            ...
            <span class="flex items-center after:content-['/'] sm:after:hidden after:mx-2 after:text-gray-200">
              <svg v-if="page == 2" class="w-3.5 h-3.5 sm:w-4 sm:h-4 me-2.5" aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                <path
                  d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
              </svg>
              <span v-else class="me-2 h-4 w-4 text-[9px] bg-gray-400 rounded-full text-white text-center">3</span>
        ...
        <div v-if="page == 0">
          <div class="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16"
            ...
            <section aria-labelledby="cart-heading" class="lg:col-span-7 py-3" :class="productsCart.length > 0 && productsCart[0].items.length > 0
              ? 'bg-white rounded-xl'
              : ''
              ">
              ...
              <ul role="list" class="divide-y divide-gray-200">
                <li v-for="item in productsCart[0].items" :key="item.id" class="flex py-6 px-4 sm:py-10">
                  ...
                  <div class="mr-4 flex flex-1 flex-col justify-between sm:mr-6">
                    <div class="relative grid grid-cols-6 gap-x-6 pl-0">
                      ...
                      <div class="col-span-1 flex items-center">
                        ...
                        <div class="mx-3">
                          <ChevronUpIcon @click="sendToCart(item.product.id)" class="h-6" />
                          <ChevronDownIcon @click="RemoveFromCart(item.product.id)" class="h-6" />
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <section aria-labelledby="summary-heading"
              ...
              <h2 id="summary-heading" class="irsa text-lg font-medium text-gray-900">
                خلاصه سفارشات
              </h2>
        ...
        <div v-if="page == 1">
          <div class="flex justify-center mt-10">
            <div id="alert-4" class="rtl flex items-center justify-start p-4 text-blue-800 rounded-3xl bg-gray-200"
              role="alert">
          ...
          <form @submit.prevent="nextStep" class="rtl">
            <div class="row">
              ...
              <div class="col-6">
                <label class="text-right w-auto mr-3 rtl mt-3 mb-0 text-sm font-medium text-gray-900" for="city">نام
                  خانوادگی:</label>
                <input
                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-2xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-none"
            ...
            <div class="">
              <label class="text-right w-auto mr-3 rtl mt-3 mb-0 text-sm font-medium text-gray-900" for="zip_code">کد
                پستی:</label>
              <input
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-2xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-none"
            ...
            <div class="">
              <label class="text-right w-auto mr-3 rtl mt-3 mb-0 text-sm font-medium text-gray-900" for="phone_number">
                تلفن منزل:</label>
              <input
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-2xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-none"
            ...
            <div class="flex mt-5">
              ...
              <div>
                <button @click="page = 0" class="px-4 py-2   mx-3 rounded-xl border">
                  بازگشت
                </button>
              </div>
        ...
        <div v-if="page == 2">
          <div class="mt-10 mx-3">
            <div class="text-xl pb-5 text-blue-700 font-semibold">پیش فاکتور</div>
            ...
            <div class="grid grid-cols-4 gap-4">
              ...
              <div class="col-span-2">
                ...
                <p class="pr-1 mt-2 text-sm">{{ first_name + ' ' + last_name }}</p>
              </div>
              <div class="col-span-2 md:col-span-1">
                <span class="text-md font-semibold">شماره همراه :</span>
                <p class="pr-1 mt-2 text-sm">{{ phone_number }}</p>
              </div>
              <div class="col-span-2 md:col-span-1">
                <span class="text-md font-semibold">شماره خانه :</span>
                <p class="pr-1 mt-2 text-sm">{{ phone_number_home }}</p>
              </div>
              ...
              <table class="min-w-full  text-right">
                <thead class="">
                  <tr class="bg-gray-200">
                    <th class="py-4 px-4  border-gray-200 rounded-s-xl">محصولات</th>
                    ...
                    <th class="py-4 px-4  border-gray-200 rounded-e-xl">مجموع</th>
                  </tr>
                </thead>
                <tbody>
                  <tr v-for="item in productsCart[0].items" :key="item.id" class="">
            ...
            <div class="row flex-row-reverse items-end">
              ...
              <div class=" col-12 col-md-6">
                <div class="flex mt-5">
                  ...
                  <div>
                    <button @click="page = 1" class="px-4 py-2 mt-5  mx-3 rounded-xl border">
                      بازگشت
                    </button>
                  </div>
                </div>
