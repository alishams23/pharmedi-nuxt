      ...
      <div v-else>
        ...
        <div v-if="page == 2">
          <div class="mt-10 mx-3">
            <span class="text-lg font-semibold">آدرس:</span>
            <p class="pr-1 mt-2 text-sm">{{ address }}</p>
          </div>
          <div class="px-3 pt-5 mx-auto">
            <div class="bg-gray-100 rounded my-6">
              <table class="min-w-full bg-gray-100 text-right">
                <thead>
                  <tr class="bg-gray-50">
                    <th class="py-4 px-4 border-b border-gray-200">محصولات</th>
                    <th class="py-4 px-4 border-b border-gray-200">قیمت</th>
                    <th class="py-4 px-4 border-b border-gray-200">تعداد</th>
                    <th class="py-4 px-4 border-b border-gray-200">تخفیف</th>
                    <th class="py-4 px-4 border-b border-gray-200">مجموع</th>
                  </tr>
                </thead>
                <tbody>
                  <tr
            ...
            <div class="flex">
              <div class="w-1/3">
                <div class="flex justify-between">
                  ...
                  <div>
                    <button
                      @click="pay"
                      class="px-4 py-2 mt-5 text-white rounded-xl bg-green-500"
                    >
                      تکمیل خرید
                    </button>
                  </div>
              ...
              <div class="w-2/3">
                <h4 class="irsa text-left pl-9 pt-2 text-base font-semibold">
                  مجموع خرید ها به همراه هزینه حمل و نقل:
                  <span class="pr-1">
                    {{ getCalculatedPrice() + getCalculatedDeliverPrice() }}
                    <span class="text-gray-500 text-xs font-light">تومان</span>
                  </span>
