  ...
  <div>
    ...
    <div v-else class="mt-2">
      ...
      <div class="d-flex flex-wrap mx-2">
        <div class="d-flex flex-row justify-content-between">
          <div v-for="category in categories" :key="category.slug"
            class="drop -color-lighter drop--down d-flex justify-content-start">
      ...
      <!-- <div class="row justify-content-center">
        <nuxt-link class="col-5 col-lg-2 text-center rounded-13 bg-white p-1 p-lg-2 me-1" to="/t/shop/physical-products">
          <p class="text-xs fw-bold ml-2">کالا های فیزیکی</p>
        </nuxt-link>
        <nuxt-link class="col-5 col-lg-2 text-center rounded-13 bg-white p-1 p-lg-2 ms-1" to="/t/shop/digital-products">
          <p class="text-xs fw-bold ml-2">کالا های دیجیتال</p>
        </nuxt-link>
      </div> -->
