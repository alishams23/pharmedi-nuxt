...
export default {
  ...
  //       { hid: 'description', name: 'description', content: this.data.body },
  //       { hid: 'og:title', property: 'og:title', content: this.data.title },
  //       { hid: 'og:type', property: 'og:type', content: "article" },
  //       { hid: 'og:description', property: 'og:description', content: this.data.body },
  //       { hid: 'og:image', property: 'og:image', content: this.data.imageBlog.photo },
